...
<head>
    ...
    <!-- CodeMirror -->
    <link href="/css/codeMirror/docs.css" rel="stylesheet"/>
    <link href="/css/codeMirror/codemirror.css" rel="stylesheet"/>
    <link href="/css/codeMirror/themes/twilight.css" type="text/css" rel="stylesheet"/>
    <link href="/css/codeMirror/themes/monokai.css" type="text/css" rel="stylesheet"/>
    <!-- End CodeMirror -->
...
<div id="header">
    <img src="/images/web_header5_quote.png">
</div>
...
<div id="footer">
    ...
    <div class="footer-middle">
        <img id="footer-img" class="hidden-xs hidden-sm hidden-md" src="/images/web-footer.png"/>

        <div id="footer-first-block">
            <h2>Contact us</h2>

            <div>
                <img id="phone-img" src="/images/phone_white.png"/>(096) 374-9502
            </div>
            <br/>

            <div>
                <img id="envelope-img" src="/images/envelope.png"/>i.i.babko@gmail.com
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <img src="/images/copyright.png" alt="copyright">2015. All rights reserved.
    </div>
</div>
...
<!-- CodeMirror -->
<script type="application/javascript" src="/js/codeMirror/codemirror.js"></script>
<script type="application/javascript" src="/js/codeMirror/matchbrackets.js"></script>
<script type="application/javascript" src="/js/codeMirror/htmlmixed.js"></script>
<script type="application/javascript" src="/js/codeMirror/xml.js"></script>
<script type="application/javascript" src="/js/codeMirror/javascript.js"></script>
<script type="application/javascript" src="/js/codeMirror/css.js"></script>
<script type="application/javascript" src="/js/codeMirror/clike.js"></script>
<script type="application/javascript" src="/js/codeMirror/php.js"></script>
<!-- End CodeMirror -->
